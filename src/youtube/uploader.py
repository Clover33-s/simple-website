    ...
    def get_authenticated_service(self):
        ...
        if not credentials or not credentials.valid:
            if credentials and credentials.expired and credentials.refresh_token:
                ...
                # The host='0.0.0.0' is crucial for making the server accessible from outside the Docker container.
                credentials = flow.run_local_server(host='0.0.0.0', open_browser=False)
